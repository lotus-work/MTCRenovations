...
@Component({
  selector: 'app-flooring-get-free-quote',
  templateUrl: './flooring-get-free-quote.component.html',
  styleUrls: ['./flooring-get-free-quote.component.css']
})
export class FlooringGetFreeQuoteComponent {
