...
@Component({
  selector: 'app-bathroom-get-free-quote',
  templateUrl: './bathroom-get-free-quote.component.html',
  styleUrls: ['./bathroom-get-free-quote.component.css']
})
export class BathroomGetFreeQuoteComponent {
