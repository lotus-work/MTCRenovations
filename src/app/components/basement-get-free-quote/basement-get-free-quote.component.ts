...
@Component({
  selector: 'app-basement-get-free-quote',
  templateUrl: './basement-get-free-quote.component.html',
  styleUrls: ['./basement-get-free-quote.component.css']
})
export class BasementGetFreeQuoteComponent {
