...
@Component({
  selector: 'app-painting-get-free-quote',
  templateUrl: './painting-get-free-quote.component.html',
  styleUrls: ['./painting-get-free-quote.component.css']
})
export class PaintingGetFreeQuoteComponent {
